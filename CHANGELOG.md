...
## [8.2.3](https://github.com/axa-group/oauth2-mock-server/compare/v8.2.2...v8.2.3) — 2026-05-27
...
- Return state on `/endsession` redirect (by [meesvandongen](https://github.com/meesvandongen) in [#391](https://github.com/axa-group/oauth2-mock-server/pull/391))
- Update dependencies

## [8.2.1](https://github.com/axa-group/oauth2-mock-server/compare/v8.2.0...v8.2.1) — 2026-01-27

### Fixed

- Allow `beforeSigning` event to modify `typ` header property (by [AndreasNill](https://github.com/AndreasNill) in [#388](https://github.com/axa-group/oauth2-mock-server/pull/388))
