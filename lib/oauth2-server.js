...
class OAuth2Server extends HttpServer {
  ...
  constructor() {
    ...
    let service = new OAuth2Service(issuer);
  ...
  /**
   * Returns the bound address, family name and port where the server is listening, or null if the server has not been started.
