...
describe('helpers', () => {
  ...
  describe('assertIsStringOrUndefined', () => {
    ...
    it('does not throw on strings', () => {
      expect(() =>
        assertIsStringOrUndefined('good', 'will not throw')
      ).not.toThrow();
    });
    ...
    describe('assertIsValidCodeVerifier', () => {
      it('should throw on invalid input', () => {
        expect(() =>
          ...
          '"Unsupported code_challenge method invalid method. The one of the following code_challenge_method are supported: plain, S256"'
        );
      });
      it('should not throw on valid input', () => {
        expect(() =>
